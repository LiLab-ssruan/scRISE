...
if __name__ == "__main__":
    ...
    parser.add_argument('--run', type=int, default=3, metavar='N',
                        help='(default: 5)')
    # Build cell graph-------------------------------------------------------------------------------------
    ...
    zOut, y_prep = gae_for(features=sm_fea, hid_dim=hid_dim,adj=adj, y_true=y, n_clusters=args.n_clusters, lr=args.lr,
                           ...
                           epochs=args.epochs, upd=args.upd, bs=args.bs, w1=10, w2=1,device=device)
    cluster_time = (time.time() - cluster_start_time)
    all_time = (time.time() - start_time)
    print("All time:",all_time,"smoothtime:",smooth_time,"cluster time:",cluster_time)
