...
if __name__ == "__main__":
    ...
    adata = sc.AnnData(x)
    adata = scnormalize(adata, copy=True, highly_genes=args.highly_genes, size_factors=False, normalize_input=True, logtrans_input=False)
    data = adata.X
    ...
    for i in range(1, args.run + 1):
        ...
        data = smooth_for(R, adj, args.gnnlayers)         
